...
INSERT INTO `box_admin_accounts` VALUES (3,'WWNsXzI0OmFjY291bnRzTVRJek5EVTJOemc9','WWNsXzI0OnBhc3N3b3JkTVRJek5EVTJOemhSY1E9PQ==','WWNsXzI0OnBob25lTVRNNE1qTXhNamsyTXpRPQ==','开发0001','&lt;i&gt;开发&amp;nbsp; &amp;nbsp;&lt;/i&gt;007',1,'3',0,'2018-06-08 15:00:44','2018-06-08 15:06:16',1);
...
CREATE TABLE `box_operation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=587 DEFAULT CHARSET=utf8 COMMENT='操作表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `box_version` VALUES (1,'1.1',1528440144,'2017-12-19 11:09:02','2018-06-08 14:42:24',1);
...
-- Dump completed on 2018-06-11  9:48:28
