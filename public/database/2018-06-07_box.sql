...
CREATE TABLE `box_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `box_menu` VALUES (1,'基本元素',1,'Nav/index','fa-cubes',1,0,1,'2018-05-30 14:59:18','2018-06-06 15:10:55',0,1),(2,'设置',1,'Menu/index','fa-cogs',1,0,9999,'2018-05-30 15:00:52','2018-05-30 15:17:26',0,1),(3,'导航管理',1,'Nav/index','',0,1,3,'2018-06-06 15:12:21','2018-06-06 16:11:30',0,1);
...
CREATE TABLE `box_operation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=534 DEFAULT CHARSET=utf8 COMMENT='操作表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `box_version` VALUES (1,'1.1',1528277791,'2017-12-19 11:09:02','2018-06-06 17:36:31',1);
...
-- Dump completed on 2018-06-07 10:08:20
